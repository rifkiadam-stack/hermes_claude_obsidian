---
name: think
description: Second Brain reasoning review for vault decisions.
version: 1.0.0
...
metadata:
  hermes:
    tags: [think, reasoning, second-brain]
    related_skills: [save]
---

# Think

**Scope:** reasoning review only; not a deterministic vault health check.
