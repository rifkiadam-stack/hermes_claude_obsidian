...
class KnowledgeContractTests(unittest.TestCase):
    ...
    def test_ambiguous_skill_routes_are_narrowed(self) -> None:
        ...
        self.assertNotIn("add this to the wiki", texts["save"])
        self.assertNotIn("add this to the wiki", texts["wiki-ingest"])
        self.assertIn("specific conversation content", texts["save"])
        self.assertIn("source material", texts["wiki-ingest"])
        self.assertIn("explicitly vault-scoped", texts["wiki-query"])
        self.assertIn("not for general markdown", texts["obsidian-markdown"])
        self.assertIn("not a deterministic vault health check", texts["think"])
        self.assertIn("does not save content", texts["wiki-mode"])
        self.assertIn("does not reason broadly", texts["wiki-lint"])
